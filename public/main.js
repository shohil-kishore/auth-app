...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Authentication Application</h1>\n  <p class=\"lead\">Welcome to our custom authentication application built from scratch using the MEAN stack</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a> <a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A Node.js/Express server using Mongoose to organise models and query the database.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p>Angular-CLI to generate components, services and more. Local dev server and simple compilation.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Full featured authentication using JSON web tokens. Login and store user data.</p>\n  </div>\n</div>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show("Success! You're logged in.", {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show("You are now registered. Please login.", {
                    cssClass: "alert-success",
                    timeout: 3000
                });
                _this.router.navigate(["/login"]);
                ...
                _this.flashMessage.show("Something went wrong. Please try again.", {
                    cssClass: "alert-danger",
                    timeout: 3000
                });
...
module.exports = __webpack_require__(/*! /Users/shohilkishore/Desktop/Work/auth-app/angular-src/src/main.ts */"./src/main.ts");
